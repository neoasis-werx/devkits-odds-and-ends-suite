...
/// </summary>
public class InfoSchemaColumnCollection : KeyedCollectionPlus<QualifiedTableColumnName, InfoSchemaColumn>
{
    /// <summary>Initializes a new instance of the <see cref="InfoSchemaColumnCollection"/> class that uses the default equality comparer.</summary>
    /// <param name="columns">The collection of <see cref="InfoSchemaColumn"/> objects to initialize the list with.</param>
    public InfoSchemaColumnCollection(IEnumerable<InfoSchemaColumn> columns)
    {
        AddRange(columns);
    }

    /// <summary>Initializes a new instance of the <see cref="InfoSchemaColumnCollection"/> class that uses the default equality comparer.</summary>
    public InfoSchemaColumnCollection()
    {
    }
